...
public class CommercialController {
    ...
    public ResponseEntity<Map<String, String>> deleteInterviewSession(@PathVariable String sessionId) {
        interviewRecordService.deleteSessionRecords(currentUserService.requireCurrentUserId(), sessionId);
