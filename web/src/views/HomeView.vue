...
const faqItems = [
  {
    q: 'nod 是做什么的？',
    a: 'nod 是面试表达训练与复盘工具：它可以结合你导入的简历与岗位方向，帮助你理解问题重点、整理回答结构，并在练习或合规授权的沟通后进行复盘。',
  },
  {
    q: '和「替考」或自动答题有什么区别？',
    a: 'nod 不会代替你作答，也不会替你出声。它提供的是问题理解、表达结构和复盘建议，最终怎么说、说到什么深度，仍由你本人基于真实经历自行完成。',
  },
  {
    q: '怎么计费？余额怎么查？',
...
<template>
  <section id="try" class="page-section cinematic-demo-section">
    <div class="cinematic-demo-shell">
      <div class="cinematic-copy">
        ...
        <p>在模拟练习和合规授权的沟通场景中，nod 可以帮助你理解问题重点，并整理成更清晰的表达思路。</p>
        <div class="cinematic-actions">
          <a class="primary-btn link-btn download-auto-link" :href="clientDownloadUrl" download>下载客户端</a>
          <RouterLink class="secondary-btn link-btn" to="/billing">查看套餐</RouterLink>
        </div>
      </div>

      <div class="demo-video-frame" aria-label="nod 整理面试问题和表达思路的演示动画">
        <div class="video-topbar">
          <div class="video-dots"><span></span><span></span><span></span></div>
          <strong>nod 表达训练辅助</strong>
          <em>录制 00:24</em>
        </div>

        <div class="demo-video-stage">
          <div class="interviewer-panel">
            <div class="panel-label">问题理解与整理</div>
          ...
          <div class="answer-panel">
            <div class="panel-label">生成的表达思路</div>
  ...
  <section class="home-hero-section balanced-hero">
    <div class="hero-card intro-card">
      ...
      <h1>让面试回答更有结构</h1>
      <p class="hero-desc">
        结合你的简历经历和练习问题，整理回答结构，帮助你更清晰地表达真实能力。
      </p>
    </div>

    <div class="hero-card preview-card">
      <div class="card-title-row">
        <h3>练习和复盘中，nod 这样帮你</h3>
        <span>结构整理</span>
      </div>
  ...
  <section class="page-section landing-section">
    <div class="page-heading center-heading">
      ...
      <h2>不是替你作答，而是帮你训练表达和复盘表现</h2>
      <p>nod 更关注回答结构、表达顺序和关键信息提炼，适合面试准备、模拟练习、项目复盘和沟通表达训练。</p>
    </div>

    <div class="stats-grid feature-grid">
      <article class="card stat-card">
        <span>问题理解</span>
        <strong>抓住表达重点</strong>
        <p>帮助识别问题真正想考察的能力点，减少答非所问。</p>
      </article>
      <article class="card stat-card">
        <span>结构提示</span>
      ...
      <article class="card stat-card">
        ...
        <p>把零散经验整理成更有逻辑、更贴近真实经历的表达。</p>
      </article>
      <article class="card stat-card">
        <span>面试复盘</span>
        <strong>自动保存每轮问答</strong>
        <p>练习或合规授权的沟通结束后，可回看问题、表达建议和记录，方便复习重点、查漏补缺。</p>
      </article>
      <article class="card stat-card">
        <span>用量透明</span>
        <strong>按分钟计费</strong>
